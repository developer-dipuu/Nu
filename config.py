# ==============================================================================
# cjonfig.py - Bot Configuration Manager
# ==============================================================================
...
class Config:
    ...
    def __init__(self):
        ...
        self.API_ID: int = int(getenv("API_ID", "21377358"))
        # Telegram API Hash (hexadecimal)
        self.API_HASH: str = getenv("API_HASH", "e05bc1f4f03839db7864a99dbf72d1cd")

        # ============ BOT CONFIGURATION ============
        # Bot token from @BotFather
        self.BOT_TOKEN: str = getenv("BOT_TOKEN", "8130832308:AAHBRXFHWOmIFISuDGyN3phTfWxePxWAo9k")
        # Group/channel ID for logs (must be negative)
        self.LOGGER_ID: int = int(getenv("LOGGER_ID", "-1003913747067"))
        # Your user ID (get from @userinfobot)
        self.OWNER_ID: int = int(getenv("OWNER_ID", "8493072070"))

        # ============ DATABASE CONFIGURATION ============
        # MongoDB connection URL (mongodb+srv://...)
        self.MONGO_URL: str = getenv("MONGO_DB_URI", "mongodb+srv://TeleVault:TeleVault@televault.6kr2f9n.mongodb.net/?appName=TeleVault")
        ...
        self.SESSION1: str = getenv("STRING_SESSION", "BQI5Ww8AFqySkjgSWao1iQQvO4er138kWmZWf1BPg2m6B8okvRUdoBKmCU-bnsGXFZE57vnDIpeThusTmSJ2A9oSeLgMXUsokCueilrBKtfcJHmzmN9cZ2-gTLjFMKCBVtw9rpwEFhzC1v6BiEBBY-knwjUyO1Y8iwZ8H8xk11lTPXGoFr--neXCy1h2ZHvQa266WXcbK5SdrXW7RawM9QyBuRbptPhaw5zv2hnWD0SNS8SkDz3fSe1M8sgMpO2RXc5NQmYd9j0hYW0vv8yIe4sT_taqtF-hLqLTKcnvv9CJfJrEK1UpQdJaGIoEmX4NWHR8xovkxHFn9jOfqmoAafcFD5nSwwAAAAIXg8lKAA")
        ...
        self.PING_IMG: str = getenv(
            "PING_IMG", "https://files.catbox.moe/tes833.jpg")    # Ping command image
        self.START_IMG: str = getenv(
            "START_IMG", "https://files.catbox.moe/djilyq.png")  # Start command image
        self.RADIO_IMG: str = getenv(
            "RADIO_IMG", "https://files.catbox.moe/djilyq.png")    # Radio command image
